...
export default {
    ...
    //生成入库单和入库详情
    CreatePutinWarehousId(sourceOrderIds,putInWarehouseType) {
        return ajax.post('/api/Background/Putinwarehous/CreatePutinWarehousId', sourceOrderIds,putInWarehouseType)
        // {
